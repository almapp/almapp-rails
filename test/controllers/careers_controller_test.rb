...
class CareersControllerTest < ActionController::TestCase
  ...
  test "should create career" do
    assert_difference('Career.count') do
      post :create, career: { faculty_id: @career.faculty_id, information: @career.information, name: @career.name, url: @career.url }
    end
  ...
  test "should update career" do
    patch :update, id: @career, career: { faculty_id: @career.faculty_id, information: @career.information, name: @career.name, url: @career.url }
    assert_redirected_to career_path(assigns(:career))
  end
